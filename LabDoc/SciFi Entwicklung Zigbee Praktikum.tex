...
\title{Entwicklung eines Zigbee Praktikums mit quelloffenem Software-Gateway}
\author{Benedikt Heuser}
\date{25.04.2022}
...
\tcbset{mystyle2/.style={
  ...
  outer arc=0pt,
  arc=0pt,
  colframe=colorscale-gray,
  colback=colorscale-gray!10,
  attach boxed title to top left,
  boxed title style={
    colback=colorscale-gray,
    outer arc=0pt,
    arc=0pt,
    top=3pt,
    bottom=3pt,
...
\newtcolorbox[auto counter,number within=section]{Fragen}[1][]{
  mystyle2,
  title=Fragen,
  overlay unbroken and first={
      \path
        ...
        \p2=(frame.north east)
        in
        node[anchor=west,font=\sffamily,color=colorscale-gray,text width=\x2-\x1] 
        at (title.east) {#1};
  }
}
...
\lfoot{\phv \raisebox{-.24\height}{\includegraphics[height=2.5ex]{media/logo_hsrm_single_bw}}\, Benedikt \textsc{Heuser}} % \, ist ein kleiner Abstand
\cfoot{\thepage}
...
\include{chapter/versuchsaufbau}
\include{chapter/musterlösung}
\include{chapter/lcm}
...
\appendix
\section{LabGuide}
\includepdf[pages=-]{../LabGuide/LabGuide-Zigbee-Praktikum.pdf}
\section{Texas Instruments SimpleLink}
\includepdf[pages=-]{./SimpleLink.pdf}
\section{Raspbe Modell 3B}
\includepdf[pages=-]{./Raspberry-Pi-Model-Bplus-Product-Brief.pdf}
\section{cod.m ZigBee RaspberryPi Modul}
\includepdf[pages=-]{./20210427_ZigBee_CC2652_Raspberry_Pi_Modul_V02_Datenblatt_Anleitung-webnc4XN2YCGznNh.pdf}
\section{Phillips Hue Dimmer Switch}
\includepdf[pages=-]{./Philips-3819421820-8718696743157_pss_.pdf}
%----------------- VERZEICHNISSE II ---------------------- %
